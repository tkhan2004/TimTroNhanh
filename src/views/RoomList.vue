...
.filter-select, .price-input, .area-input {
  width: 100%;
  padding: 10px;
  margin-bottom: 10px;
  border: 1px solid #e0e0e0;
...
.price-range-inputs, .area-range-inputs {
  display: flex;
  align-items: center;
  gap: 10px;
  position: relative;
...
.price-presets, .area-presets {
  display: grid;
  grid-template-columns: repeat(2, 1fr);
  gap: 10px;
}

.price-preset-btn, .area-preset-btn {
  padding: 8px;
...
.price-preset-btn:hover, .area-preset-btn:hover {
