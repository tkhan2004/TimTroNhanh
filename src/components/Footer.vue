    ...
    <div class="footer-container">
      <div class="footer-grid">
        <div class="footer-column">
          <h4 class="footer-column-title">Về Thuê Trọ</h4>
        ...
        <div class="footer-column">
          <h4 class="footer-column-title">Dịch Vụ</h4>
          <ul class="footer-links">
            <li><a href="#">Đăng tin miễn phí</a></li>
            <li><a href="#">Quảng cáo phòng trọ</a></li>
            <li><a href="#">Hỗ trợ người thuê</a></li>
            <li><a href="#">Hỗ trợ chủ nhà</a></li>
          </ul>
        </div>
        ...
        <div class="footer-column">
          ...
          <div class="footer-social-links">
            ...
            <a href="#" class="social-link">
              <svg viewBox="0 0 24 24" class="social-icon">
                <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.246 11.626.245 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"></path>
              </svg>
            </a>
            <a href="#" class="social-link">
              <svg viewBox="0 0 24 24" class="social-icon">
